---
title: "Assignment 5 Pradeep Reddy Kethu"
author: "Pradeep Reddy Kethu"
date: "2022-11-15"
output:
...
```{r}
c<-read.csv("C:/Users/prade/Downloads/Cereals.csv")
c<- na.omit(c)
head(c)
```
...
```{r}
Healthy_cereal <- na.omit(read.csv("C:/Users/prade/Downloads/Cereals.csv"))
